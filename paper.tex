...
{\centering \includegraphics[width=0.75\linewidth]{figures/directory-structure} 
...
{\centering \includegraphics[width=0.75\linewidth]{figures/json-code} 
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{figures/data_sharing_workflow} \caption{The steps required compared to effort required for data sharing for reproducibility.}\label{fig:data-sharing-workflow}
\end{figure}
...
{\centering \includegraphics[width=0.6\linewidth]{figures/sdss-raw-data-screenshot} 
