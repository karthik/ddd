...
(**note: still need to work on this**)

Data should be deposited into a relevant domain repository. For example, gbif [@gbif] for species data, or genbif or genbank for genetics data @GenBank. Information on other domain specific repositories can be found at https://www.nature.com/sdata/policies/repositories. 

As discussed in \@ref(cite), archive data using a platform generating an accession number such as a DOI. For sharing data collected for research, the most relevant homes for general data are the research data repositories **zenodo** and **dryad**. In addition to minting DOIs, they also provide citation templates.

If using a research institute's library service to share data, ensure a DOI is provided so it can be accurately identified and cited.
...
- https://www.the-scientist.com/news-opinion/top-spider-biologists-research-under-fire-67083
