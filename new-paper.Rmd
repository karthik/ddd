...
(**note: on what to say**)
1. Data should go into Domain area - e.g., gbif for species data, or genbif or genbank for genetics data @GenBank. More information can be found at https://www.nature.com/sdata/policies/repositories. Importantly, domain areas should provide some form of accession number. 

As discussed in \@ref(cite), archive data using a platform generating an accession number such as a DOI. For sharing data collected for research, the most relevant homes for general data are the research data repositories **zenodo** and **dryad**. In addition to minting DOIs, they also provide citation templates that can be used in \@ref(cite).
