...
Do not deposit data in local file storage that does not provide DOI or accession numbers. For example, [@50Hectares] was hosted on a university server and accessed via FTP for over a decade. It was not possible to effectively provide effective provenance and credit. Only recently was the data deposited in Dryad [@condit-2019].
