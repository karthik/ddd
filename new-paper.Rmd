...
(**note: this bit needs some work**)
A trusted repository (such as Dryad) will manage citation for you. However, a CITATION file allows you to mention specifically how you want your data to be cited - this could point to the paper that used or described the data and collection methods, for example.
