...
Provide a license with your data. A license for data establishes the rules for its use, and whether it can be modified or shared. Without a license, or with a non-standard one, these rules are unclear, and can lead to issues with use, attribution and citation. While there are a handful of licenses for data [@data_world_inc_common_2019], we recommend the CC0 license, as it provides simple rules for attribution, warranty, and use, and is very common. The CC0 allows data owners to waive all rights and data licensed as such can be freely shared, copied, modified, and distributed, even for commercial purposes without permission.  For more information on the benefit of using CC0, and why CCBY is not always appropriate, see https://osc.universityofcalifornia.edu/2016/09/cc-by-and-data-not-always-a-good-fit/. Short and full overviews of CCBY and CC0 can be found at [@cc0-short; @cc0-long].
