---
title: Barriers to meaningful data sharing
...
Nicholas Tierney has an honours degree in Psychological Science, and a PhD in Statistics. He is a research software engineer at Telethon Kids Institute in Perth, Australia, working on maintaining and extending statistical software and establishing research software pipelines. His research ranges from exploratory data analysis, to statistical modelling, calculating diagnostics, and how we draw inferences, and make decisions from data. Crucial to this work is producing high quality software to accompany each research idea. Nick is a keen outdoorsman and photographer.
