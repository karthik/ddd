...
Some data repositories and journals will automatically require a license when submitting data. For example, Dryad requires CC0[^7][^8], and the journal PLOS Comp Bio, requires licences for data that are not more restrictive than CC BY[^9].

[^7]: <https://blog.datadryad.org/2011/10/05/why-does-dryad-use-cc0/>

[^8]: <https://datadryad.org/stash/faq>

[^9]: <https://journals.plos.org/ploscompbiol/s/data-availability>
...
Do not deposit data in local file storage that does not provide DOI or accession numbers. For example, [@50Hectares] is hosted on a university server and accessed via FTP. It is not possible to effectively provide effective provenance and credit.
