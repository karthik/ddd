...
Including data in a python package: [@include-data-py-pkg]
...
Below is an example data dictionary table taken from the [Tidy Tuesday repository on incarceration trends](https://github.com/rfordatascience/tidytuesday/tree/master/data/2019/2019-01-22) [@tidy-tuesday-incarcerate]. This includes information on the variable the class (type) of the variable, and a longer description of the variable.
